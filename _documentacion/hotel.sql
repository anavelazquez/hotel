...
CREATE TABLE `clientes`  (
  ...
  `primer_apellido` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `segundo_apellido` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `edificios`  (
  ...
  `nombre_edificio` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `estatus_habitacion`  (
  ...
  `descripcion_estatus_habitacion` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `estatus_reservacion`  (
  ...
  `descripcion_estatus_reservacion` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `habitaciones`  (
  ...
  `nivel_piso` varchar(3) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `numero_habitacion` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `pantallas`  (
  ...
  `descripcion_pantalla` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `roles`  (
  ...
  `descripcion_rol` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `tipos_habitacion`  (
  ...
  `descripcion_tipo_habitacion` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `vistas`  (
  ...
  `descripcion_vista` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
